    ...
    'components' => [
        ...
        'urlManager'=>[
            ...
            'rules' => [
                ...
                'discipline/<id_program:\d+>/<page:\d+>' => 'discipline/main/index',
                'discipline/<id_program:\d+>' => 'discipline/main/index',
                'student/<id_program:\d+>/<page:\d+>' => 'student/main/index',
                'student/<id_program:\d+>' => 'student/main/index',
                'student/result/<id:\d+>/<page:\d+>' => 'student/result/index',
                'student/result/<id:\d+>' => 'student/result/index',
                'discipline/result/<id:\d+>/<page:\d+>' => 'student/result/discipline',
                'discipline/result/<id:\d+>' => 'student/result/discipline',                'discipline/result/<id:\d+>' => 'student/result/discipline',
